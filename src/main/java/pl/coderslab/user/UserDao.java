...
public class UserDao {
    ...
    public User create(User user) {
        try (Connection conn = DbUtil.getConnection()) {
            ...
            PreparedStatement refreshId = conn.prepareStatement("SET @num := 0;");
            PreparedStatement refreshAll = conn.prepareStatement("UPDATE workshop2.users SET id = @num:=(@num+1);");
            PreparedStatement refreshAIncrement = conn.prepareStatement("ALTER TABLE workshop2.users AUTO_INCREMENT=1;");
            refreshId.executeUpdate();
            refreshAll.executeUpdate();
            refreshAIncrement.executeUpdate();
